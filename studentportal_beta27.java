...
public class studentportal_beta27 {
                ...
                if(tries > 2){
                    ...
                    while(true){
                        ...
                        if(user_choice_ForgetPassword.equals("y")){
                            ...
                            if(forget_password_3Attempts < 2){
                                break email_forgot;
                            }
                                                ...
                                                if (leap_year == 0) {
                                                    ...
                                                    while(true){
                                                        ...
                                                        if(birth_month.matches("[a-z]+") && birth_month.equals("jan") || birth_month.equals("january") || birth_month.equals("mar") || birth_month.equals("march") || birth_month.equals("may") || birth_month.equals("jul") || birth_month.equals("july") || birth_month.equals("aug") || birth_month.equals("august") || birth_month.equals("oct") || birth_month.equals("october") || birth_month.equals("dec") || birth_month.equals("december") ){
                                                            ...
                                                            System.out.println("==============================:[ STUDENT CREDINTIALS]:============================== ");
                                                            for (int second_for_Months_31_days = 0; second_for_Months_31_days < list.size(); second_for_Months_31_days++) {
                                                                Object[] element = list.get(second_for_Months_31_days);
                                                                System.out.println("|" + (1 + second_for_Months_31_days) +"| STUDENT NAME: " + element[7] + " | BIRTHDAY: " + element[8] );
                                                            }
                                                            ...
                                                            System.out.println("==============================:[ STUDENT CREDINTIALS]:============================== ");
                                                            for (int second_for_Months_30_days = 0; second_for_Months_30_days < list.size(); second_for_Months_30_days++) {
                                                                Object[] element = list.get(second_for_Months_30_days);
                                                                System.out.println("|" + (1 + second_for_Months_30_days) +"| STUDENT NAME: " + element[7] + " | BIRTHDAY: " + element[8] );
                                                            }
