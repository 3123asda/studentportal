...
public class studentportal_beta17 {
        ...
        while (true) {
            ...
            for (Object[] account : list) {
                if (email.equals(account[0]) && password.equals(account[1])) {
                    ...
                    //System.out.println("|    APP 003   | FILIPINO SA PILING LARANGAN                    | ZAPANTA, FRANCISCO III E.    |   4  | COC-FB1-G12-01-PROG |      " + account[5] + "     |");
                    //System.out.println("|    APP 006   | PRACTICAL RESEARCH 2                           | BAHAN, ROSELYN -             |   4  | COC-FB1-G12-01-PROG |      " + account[3] + "     |");
                    //System.out.println("|    COR 015   | INTRODUCTION TO PHILOSOPHY OF THE HUMAN PERSON | MIÑOZA, MARK ANTHONY TENEBRO |   4  | COC-FB1-G12-01-PROG |      " + account[4] + "     |");
                    //System.out.println("|    COR 019   | PHYSICAL EDUCATION AND HEALTH 3                | ATLAWAN, DEXTER REY D.       |   4  | COC-FB1-G12-01-PROG |      " + account[6] + "     |");
                    //System.out.println("|    ICT 001   | COMPUTER PROGRAMMING (NC III)                  | BAGUIO, RALPH ANGELO E.      |   4  | COC-FB1-G12-01-PROG |      " + account[2] + "     |");
                    System.out.println("|              |                                                |                              |      |                     |             |         |");
