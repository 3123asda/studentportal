...
public class studentportal_beta25 {
                                    ...
                                    if(middle_name.matches("[a-z]+") && middle_name.equals("none")){
                                        ...
                                        while (true){
                                            ...
                                            if(last_name.matches("[a-z]+")){
                                                ...
                                                student_duplicate_name = first_name + " " + last_name ;
                                            ...
                                            try {
                                                ...
                                                while (true){
                                                    ...
                                                    if(last_name.matches("[a-z]+")){
                                                        ...
                                                        student_duplicate_name = first_name + " " + middle_name + " "+ last_name;
                                                        student_duplicate_name_ConvertUpperCase = student_duplicate_name.toUpperCase();
                                                ...
                                                if (leap_year == 0) {
                                                    ...
                                                    while(true){
                                                        ...
                                                        if (birth_month.matches("[a-z]+") && birth_month.equals("jan") || birth_month.equals("january")) {   
                                                            ...
                                                            for (int first_for_jan = 0; first_for_jan < list.size(); first_for_jan++) {
                                                                Object[] element = list.get(first_for_jan);
                                                                System.out.println("|" + (1 + first_for_jan) +"| STUDENT NAME: " + element[7] + " | BIRTHDAY: " + element[8] );
